...
func _load_settings():
	...
	audio_player.set_volume("Master",master_level)
	audio_player.set_volume("Button",buttons_level)
	audio_player.set_volume("Effect",sound_effects_level)
	audio_player.set_volume("Music",music_level)
